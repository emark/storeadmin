...
my $result = $ua->get("http://api.sms24x7.ru/?method=push_msg&email=$appcfg{sms24mail}&password=$appcfg{sms24pass}&text=$decode_msg&phone=$tel&api_v=1.1&nologin=true&format=json")->res->body;
